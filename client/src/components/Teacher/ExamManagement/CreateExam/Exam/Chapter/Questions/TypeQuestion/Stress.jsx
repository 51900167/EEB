...
const Stress = ({
  ...
  // Click checked thì lấy value của input
  const handleRadioChange = (indexOption) => {
    const input = answerRefs.current[indexOption].current;
    if (input) {
      handleCorrectAnswerChange(
        indexChapter,
    ...
    console.log("Chọn radio show value: ", input)
  };
        ...
        {question.options.map((option, indexOption) => (
          <div key={indexOption} className="flex items-center pt-2">
            ...
            <input
              ...
              onChange={() => handleRadioChange(indexOption)}
            ...
            <input
              ...
              value={option.replace(/<\/?u>/g, "")} // Loại bỏ các thẻ tag trong input
              onChange={(e) =>
                handleChangeOptionsQuestion(indexChapter, indexQuestion, {
                  ...question,
