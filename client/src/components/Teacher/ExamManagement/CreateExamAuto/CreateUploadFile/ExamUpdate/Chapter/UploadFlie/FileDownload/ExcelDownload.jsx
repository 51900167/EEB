  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center w-[50%] px-2 py-2.5 rounded-lg text-sm tracking-wider font-medium border border-green-700 outline-none bg-transparent hover:bg-green-700 text-green-700 hover:text-white transition-all duration-300"
      >
