...
const WordDownload = ({ addDataUploadToChaptersIndex, openDetailUpload, closeShowUpdateFile, sendChapterToExam, dataFormUploadIndex }) => {
  ...
  return (
    <div className="inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] behtmlFore:fixed behtmlFore:inset-0 behtmlFore:w-full behtmlFore:h-full behtmlFore:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
