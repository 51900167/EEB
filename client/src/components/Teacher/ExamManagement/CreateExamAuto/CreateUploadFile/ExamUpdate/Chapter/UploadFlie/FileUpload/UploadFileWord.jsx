...
const UploadFileWord = ({ sendDataToExam, sendFileToChildrenWord }) => {
  ...
  console.log("Đã qua Word Upload");
  console.log("handleFileUploadWord: ", sendFileToChildrenWord);
 ...
 */
  ...
  return <div><p>Processing Word file...</p> {/* Hiển thị thông báo đang xử lý file Word */}</div>;
};
