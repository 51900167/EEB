      ...
      <div className="grid md:grid-cols-2 md:gap-6">
        <div className="z-0 w-full mb-5 group">
          ...
          >
            ...
            <option value="Tiếng anh lớp 6">Tiếng anh lớp 6</option>
            <option value="Tiếng anh lớp 7">Tiếng anh lớp 7</option>
            <option value="Tiếng anh lớp 8">Tiếng anh lớp 8</option>
            <option value="Tiếng anh lớp 9">Tiếng anh lớp 9</option>
            <option value="Tiếng anh lớp 10">Tiếng anh lớp 10</option>
            <option value="Tiếng anh lớp 11">Tiếng anh lớp 11</option>
            <option value="Tiếng anh lớp 12">Tiếng anh lớp 12</option>
          </select>
        </div>
        <div className="relative z-0 w-full mb-5 group">
          <label
