...
const LoginPage = () => {
  ...
  const role = "Student"; // Đặt cố định vai trò là "Student"
      ...
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          ...
          <div className="absolute bottom-0 w-full text-center p-4">
            <Link to="/teacher/login" className="text-sm text-white hover:text-stone-300   focus:text-stone-700 focus:outline-none">
              Login as Teacher
            </Link>
          </div>
        </div>
