...
// export const getActiveSemestersWithClasses = async (schoolYearId) => {
//   try {
//     const response = await fetch(`${process.env.REACT_APP_API_URL}/head/getactivesemesterswithclasses?schoolYearId=${schoolYearId}`, {
//       method: 'GET',
//       headers: {
//         'Content-Type': 'application/json'
//       }
...
//     if (!response.ok) {
//       throw new Error('Error fetching active semesters with classes');
//     }

//     return response.json();
//   } catch (error) {
//     throw new Error(`Error in getActiveSemestersWithClasses: ${error.message}`);
//   }
// };